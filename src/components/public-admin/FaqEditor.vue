<template>
  <section ref="editorRoot" class="structured-editor" data-editor="faq" aria-labelledby="faq-editor-title" tabindex="-1">
...
const props = defineProps({ items: { type: Array, default: () => [] }, busy: Boolean, createAck: { type: Number, default: 0 }, labels: { type: Object, required: true } })
...
function resetCreateForm() { Object.assign(createForm, { question: '', answerMarkdown: '', isVisible: true, sortOrder: 0 }) }
