...
function change(key, value) { form[key] = value; emit('change', { ...form, page: 1 }) }
</script>
...
<style scoped>.pricing-filters{display:grid;gap:16px}.pricing-filters label{display:grid;gap:6px;color:var(--public-muted);font-size:13px;font-weight:700}.pricing-filters input,.pricing-filters select{width:100%;min-height:44px;padding:0 12px;border:1px solid var(--public-border);border-radius:8px;background:var(--public-card);color:var(--public-text);font-size:13px}.pricing-filters :focus-visible{outline:3px solid color-mix(in srgb,var(--public-primary) 35%,transparent);outline-offset:2px}</style>
