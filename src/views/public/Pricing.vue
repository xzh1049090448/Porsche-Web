...
let searchTimer; let disposed = false; const auth = shallowRef(null); let stopAuth = null; let authProbe = null; let desktopQuery = null
...
onBeforeUnmount(() => { disposed = true; clearTimeout(searchTimer); stopAuth?.(); desktopQuery?.removeEventListener('change', handleDesktopChange); store.cancel('models') })
</script>
